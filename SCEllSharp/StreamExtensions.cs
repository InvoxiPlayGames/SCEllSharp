 ...
 * Use it if you wish.
 * 
 * From: https://github.com/maxton/GameArchives/blob/master/Library/StreamExtensions.cs
 */
using System.Text;
namespace SCEllSharp
{
    internal static class StreamExtensions
    {
        ...
        /// <returns></returns>
        public static void WriteUInt32BE(this Stream s, uint uint32) => s.WriteInt32BE((int)uint32);
        ...
        /// <returns></returns>
        public static void WriteUInt64BE(this Stream s, ulong uint64) => s.WriteInt64BE((long)uint64);
